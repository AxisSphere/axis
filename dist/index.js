...
const chalk_1 = __importDefault(__nccwpck_require__(276));
class Logger {
    minLevel;
    ...
    format(level, msg) {
        ...
        switch (level) {
            case "debug":
                label = chalk_1.default.gray(label);
                break;
            case "info":
                label = chalk_1.default.blue(label);
                break;
            case "warn":
                label = chalk_1.default.yellow(label);
                break;
            case "error":
                label = chalk_1.default.red(label);
                break;
        }
        return `${chalk_1.default.dim(timestamp)} ${label} ${msg}`;
    }
    shouldLog(level) {
